<p align="center">
  <em>Ticketing built for AI agents. Humans welcome.</em>
</p>
...
- The data model maps to how agents actually work: claim → plan → execute → complete
- Humans get a clean task list, not another dashboard to manage
